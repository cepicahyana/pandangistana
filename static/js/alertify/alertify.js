...
( function ( window ) {
    ...
    var defaults = {
        ...
        theme:{
            input:'ajs-input',
            ok:'btn bg-blue-grey waves-effect waves-light col-white',
            cancel:'btn bg-blue-grey waves-effect waves-light col-white',
        }
    };
    ...
    var dialog = (function () {
        var //holds the list of used keys.
            ...
            templates = {
                ...
                header: '<div class="font-bold col-pink ajs-header"></div>',
