...
$saldo=$this->db->query("select saldo from admin where id_admin='".$this->session->userdata("id")."'")->row();
$saldo=$saldo->saldo;
$quota=$this->db->query("select quota from data_invoice where id_data_event='".$data->id_data_event."'")->row();
$quota=$quota->quota;
?>
            ...
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <img class="imgsibuta" src="<?php echo base_url();?>plug/img/barcodevent.png" style="max-width:300px">
                            </td>
