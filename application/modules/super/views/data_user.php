  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('super/ajax_open/'.$this->uri->segment(3).'')?>",
            "type": "POST"
        },
    ...
    function deleted(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url:"<?php echo base_url();?>super/deleted_UG/"+id,
            type: "POST",
            dataType: "JSON",
	...
	{
	$.ajax({
		url:"<?php echo base_url();?>super/dropdownHak/"+id,
		type: "POST",
		data:"",
		 success: function(data)
				{
	...
	$("#msg").html("");
      ...
      $.ajax({
        url : "<?php echo base_url();?>super/ajax_edit/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {	 pilih(id)
