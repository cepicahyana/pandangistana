...
<h2 class=" black b">Log History</h2>
...
<table id='table' class="tabel black table-striped table-bordered table-hover dataTable">
		  	<thead>			
				...
				<th class='thead' axis="date">Tanggal</th>
				<th class='thead' axis="date">Group</th>
				<th class='thead' axis="date">User Name</th>
				<th class='thead' axis="string">Table Changed</th>
				<th class='thead' axis="string">Actions</th>
				<th>&nbsp;</th>
			</thead>
</table>
