               ...
               <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card" >
						...
						<h2 class="sound">DATA YANG TELAH DIKIRIM NOTIFIKASI</h2> 
                        </div>
						    <div class="body"> 
...
<span style='color:black;position:absolute;margin-top:-40px;z-index:222' class="cursor btnhapus">
 <a class="  btn bg-deep-orange" href="#" onclick="kirim()"><i class='material-icons'>send</i> Kirim Notifikasi Pengambilan</a> 
</span>
...
<table id='table' class="tabel black table-striped table-bordered table-hover dataTable">
 <tr> 		  	<thead class='bg-teal'>	
				 	...
				 	<th rowspan="2" class='thead'>NO</th>
    ...
    $("[name='hapus[]']").each(function () {
        ...
        if (ischecked) {
            checkbox_value += $(this).val() + ",";
           	 ...
           	 $.post("<?php echo base_url();?>notif/kirim/",{id:checkbox_value},function(){
  ...
  <script type="text/javascript">
	...
	// ajax delete data to database
          $.ajax({
            url : "<?php echo base_url();?>notif/getBarcode/"+id,
            type: "POST",
            data: "JSON",
            success: function(data)
            {
